...
Развиваюсь в тестировании и автоматизации на Java. Здесь собраны мои учебные решения: модульные проверки, тесты API, браузерные сценарии и Android UI-тесты.
