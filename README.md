...
Развиваюсь в тестировании и автоматизации на Java. Здесь собраны мои учебные решения: модульные проверки, тесты API, браузерные сценарии и Android UI-тесты, а также проекты по Java и Spring Boot.
...
В README проектов описаны требования к окружению, команды запуска и ограничения проверок. Работы учебные; тексты заданий и закрытые учебные материалы не публикуются.
